...
## Purpose
Define the mapping between motor encoders and wheel PID feedback channels, the per-wheel direction sign convention, and the wiring documentation so the robot drives straight and predictable.
